...
// Body font per WEBSITE_SPEC §8.2 — paired with Cinzel display font (loaded
// via stylesheet link in <head> below, since Cinzel is used in heading-display
// via Tailwind font-display). Inter loads with display:swap (Next.js default).
const inter = Inter({
  subsets: ['latin'],
  display: 'swap',
  variable: '--font-inter',
...
export const metadata: Metadata = {
  ...
  // icon + apple-icon are auto-generated by Next.js from app/icon.png + app/apple-icon.png
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={inter.variable}>
      ...
      <body className={`${inter.className} bg-bg-dark text-text-primary min-h-screen flex flex-col`}>
        <Header />

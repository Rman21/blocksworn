...
- [ ] T3.11 — Shared Tower-Hearts pool + shared TOWER_PACTS selection — **ACTIVE** (wires T3.10's `sharedState.towerHearts/towerPacts` schema fields; sacred Tower retry ladder + TOWER_PACTS READ-only)

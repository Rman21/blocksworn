...
- **Phase progress:** 15 / 20 done (T1.01-T1.15)
...
- **Active task:** T1.16 — DELETE legacy `--v-*` CSS tokens (verify/finalize)
- **Phase 1 endgame:** T1.16-T1.20 cleanup over legacy → Roman merge PR #158 → Phase 2 Identity Layer starts

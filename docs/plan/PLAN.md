...
- [ ] T3.10 — Party Tower async architecture (per ADR-002) — **ACTIVE** (Wave 5 foundation; Firestore party docs + turn state machine; 24h default + 4h/7d opt-in per ESC-03 Q3)
